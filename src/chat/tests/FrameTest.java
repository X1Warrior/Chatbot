...
public class FrameTest
{
	...
	{
		assertNotNull("Controller data member needs to be initialized", testedFrame.getChatbotController());
		assertTrue("Controller must be an instance of ChatbotController", testedFrame.getChatbotController() instanceof ChatbotController);
	}
